<div id="activity">
                                    ...
                                    @if(($todayAppointmentsPaginate ?? $filteredAppointment)->count() > 0)
                                        @foreach ($todayAppointmentsPaginate ?? $filteredAppointment as $appointment)
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                {{ ($todayAppointmentsPaginate ?? $filteredAppointment)->links('partials.pagination') }}
                                            </div>
                                        </div>
                                        @else
